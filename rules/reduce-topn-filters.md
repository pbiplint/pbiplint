...
The fix takes the Top N filter off the table, where it was on the same field as the bar chart's, Product Name. That leaves two visuals with a Top N filter, which a threshold of 2 allows.
